...
extern "C" int serialReadUntilSequence(
    int64_t handle_ptr, void* buffer, int buffer_size, int timeout_ms, int multiplier, void* sequence_ptr, ErrorCallbackT error_callback)
{
    ...
    {
        invokeError(
            std::to_underlying(cpp_core::StatusCodes::kInvalidHandleError), "serialReadUntilSequence: Invalid handle", error_callback);
